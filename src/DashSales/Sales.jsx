...
const Sales = ({ Assigned = "1000000", compleated = '800000', pending = '200000' }) => {
        ...
        >
            ...
            <Grid container spacing={2} margin={0} padding={0} width={'100%'}>
                <Grid item xs={12} style={{ padding: '0' }}>
                    ...
                    <Table aria-label="table variants" variant={'outlined'} borderAxis={'bothBetween'} color={'neutral'}>
                        <thead>
                            <tr style={{ width: '50%' }}>
                                <th style={{ width: '100%', minWidth: '135px', padding: "15px 35px 15px 34px" }}>
...
const RangeSlider = ({ compleatedValue }) => {
    ...
    console.log(typeof (bgcolor), bgcolor, "aaa")
